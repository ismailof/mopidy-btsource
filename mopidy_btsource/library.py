...
HTTP_URI = '/btsource/'
ICON_BT = {'uri' : HTTP_URI + 'icon_bt_music.png', 'width' : 150, 'height': 150}
...
class BTSourceLibWrapper(backend.LibraryProvider):
    ...
    """    
    root_directory = models.Ref.directory(uri=BTPlayerUri.BT_ROOT, name='Bluetooth')
    ...
    def browse (self, uri):   
        ...
        if uri == BTPlayerUri.BT_ROOT:
            ...
            #Discover directory
            result.append( models.Ref.directory(uri=BTPlayerUri.BT_SCAN, name='Scan for Devices') )            
    ...
    def compose_bt_track(self, uri=BTPlayerUri.BT_SONG):
        ...
        #return translate_track_data(self.bt_player.get_current_track(), BTPlayerUri.BT_SONG)
